...
- **R1 - ground truth is falsifiable:** the new fixture's verifier checks
...
- **R2 - prompt is self-sufficient:** the new fixture's `prompt.md`
  describes the `greet-user` task on its own terms, without assuming the
  reader already knows conventions from this fixture-design process.
- **R3 - verifier is deterministic and scoped:** the new fixture's
